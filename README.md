...
**6** parts across **5** microcodes, **0** commands described by hand, **112** exchanges read out of **36** real cartridges compared, **0** failures, **935** tests, **100%** statement and branch coverage, no dependencies
